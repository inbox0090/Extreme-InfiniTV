<script>
  ...
  // The picker now lives in the account menu rather than the expandable rail.
  // Keep its original list rendering and actions, but always open in place.
...
<div
  ...
  <button
    ...
    class="flex w-full min-w-0 items-center justify-between gap-2.5 px-2.5 py-2.5 min-h-11 rounded-xl border border-line bg-surface text-sm font-medium text-fg transition-colors hover:bg-surface-2 focus-visible:bg-surface-2 focus-visible:border-accent">
